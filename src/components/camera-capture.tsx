      ...
      {preview ? (
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <span className="text-sm">Use your camera to scan a label</span>
          </button>
          <button
            onClick={() => uploadRef.current?.click()}
            className="w-full rounded-xl border-2 border-gray-300 py-4 flex items-center justify-center gap-2 text-gray-500 hover:border-purple-400 hover:text-purple-500 transition-colors"
          >
