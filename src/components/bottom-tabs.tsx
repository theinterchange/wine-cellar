...
export default function BottomTabs() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-sm shadow-[0_-1px_3px_rgba(0,0,0,0.05)] pb-[env(safe-area-inset-bottom)] z-50">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <Link
              key={tab.href}
              href={tab.href}
              className={`flex flex-col items-center py-2.5 px-4 text-xs transition-colors ${
